...
public class MemberController {
	...
	@RequestMapping(value = "/member/pwdFix.do", method = RequestMethod.GET)
	public Map<String, Object> pwdFix(Locale locale, Model model,
			@RequestBody HashMap<String, String> map) {
		logger.info("비밀번호 수정");
		//아이디 넣어주기
		Map<String, Object> result = new HashMap<>();
		memberService.pwdFix(map.get("MEMBER_PW"));
		result.put("status", true);
		result.put("message", "비밀번호가 수정되었습니다");
		result.put("url", "/DZ_shop/");
		return result;
	}
