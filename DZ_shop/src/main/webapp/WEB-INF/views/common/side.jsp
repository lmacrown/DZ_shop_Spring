...
<nav class="sidebar">
	...
	<div class="sidebar-body">
		<ul class="nav">
			...
			<li class="nav-item"><a href="/DZ_shop/"
				class="nav-link"> <i class="link-icon" data-feather="box"></i> <span
			...
			<li class="nav-item"><a class="nav-link"
				href="/multichat/jsp/post/post.jsp"> <i class="link-icon"
					data-feather="anchor"></i> <span class="link-title">일반 게시판(미구현)</span>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="/DZ_shop/post/QnA.do"> <i class="link-icon"
