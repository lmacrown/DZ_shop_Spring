...
public class AdminService {
	...
	public QnAVO QnAView(String qnA_Num) {
		return adminDAO.QnAView(qnA_Num);
	}
	...
	public void QnA_reply(String qna_Num, String qna_reply) {
		 adminDAO.QnA_reply(qna_Num, qna_reply);
	}
