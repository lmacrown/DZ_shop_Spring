...
public class HomeController {
	...
	public String home(Locale locale, Model model, HttpSession session,
		...
		logger.info("총 페이지 수 : " + totalPageNo + ", 시작 페이지 : " + startPageNo + ", 끝 페이지 : " + endPageNo + ", 현재 페이지 : "
				+ pageNo);
		...
		if ((Boolean) session.getAttribute("isLogOn") != null) {
			...
			memberService.addPreSearch(text, memberId);
			model.addAttribute("preSearch", memberService.searchPreSearch(memberId));
		}
		return "home";
	}
