...
<div style="margin-left: 10%; margin-top: 10px;">
	<nav>
		<div>
			<ul id="sortSelect" class="nav page-navigation" style="border: 3px solid yellow; width: 80%;">
			...
			<div style="float: right; width: 20%; margin-top: -45px; margin-left: 5px">
				<c:if test="${isLogOn}">
					...
					<div style=	"border: solid 1px gray; margin-top: 150px">
						<h5>최근 검색 목록</h5>
						<c:forEach var="preSearch" items="${preSearch}">
							<tr>
								<td>${preSearch}</td><br/>
							</tr>
						</c:forEach> 
...
let selectBt = document.querySelector("#sortSelect");
